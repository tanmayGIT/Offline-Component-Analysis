function [FilteredConnectedCom] =  wordSpottingBatchOperation_GW(Img)
...
HoldConnecComMoreRefined{Chk,1}(1,3) = globalMinRow;
HoldConnecComMoreRefined{Chk,1}(1,4) = globalMinCol;



HoldConnecComMoreRefined{Chk,1}(2,3) = globalMinRow;
HoldConnecComMoreRefined{Chk,1}(2,4) = globalMaxCol;

HoldConnecComMoreRefined{Chk,1}(3,3) = globalMaxRow;
HoldConnecComMoreRefined{Chk,1}(3,4) = globalMinCol;


HoldConnecComMoreRefined{Chk,1}(4,3) = globalMaxRow;
HoldConnecComMoreRefined{Chk,1}(4,4) = globalMaxCol;
