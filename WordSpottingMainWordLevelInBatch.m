...
function WordSpottingMainWordLevelInBatch()
...
matlabpool open;
[segmentedDocImageSequence] = batchProcessDocumentsOfflineMatch(dirOutput,fileNames,@wordSpottingBatchOperationOffline);
