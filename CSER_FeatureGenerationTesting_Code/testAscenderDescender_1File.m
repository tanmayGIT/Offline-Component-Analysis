...
% dirOutput = uigetdir('/Users/tanmoymondal/Documents/Study Guru/STUDY GURU/Dataset/dickDoom/AllComponents/Francois/','Select a folder');
% files = dir(fullfile(dirOutput, '*.jpg'));
% fileNamesRef = {files.name}';
% imgPathRef = strcat(dirOutput,'/');
% nImagesRef = (length(fileNamesRef));

[FileName,PathName,FilterIndex] = uigetfile('/Users/tanmoymondal/Documents/Study Guru/STUDY GURU/Dataset/dickDoom/AllComponents/Francois/*.jpg','Select a file');

imageFilePath_3 = '/Users/tanmoymondal/Documents/Study Guru/STUDY GURU/Dataset/dickDoom/AllComponents/Francois/oneImage';
...
if(nCol > (3*30))
    ...
    imwrite(afterBinarizedTest,[path, (int2str(123)) '.jpg']);
    %     disp(goEachRefImg);
