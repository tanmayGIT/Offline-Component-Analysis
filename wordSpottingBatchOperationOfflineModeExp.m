function [mergeAllTogether] =  wordSpottingBatchOperationOfflineModeExp(Img)
% global beforeRLSA;
% global refComponentMat;
% global imageFilePath_4;
% global str1;

[beforeRLSA,afterRLSA,startText,horiRLSAThresh,verRLSAThresh] = wordSpottingBasicOperationExp(Img); % for full image
...
for Chk = 1:size(HoldConnecComMoreRefined,1)
